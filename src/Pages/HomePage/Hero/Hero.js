...
const Hero = () => {
    return (
      <div className="hero-bg d-md-flex justify-content-center align-items-center">
          ...
          <div className="px-md-3">
            ...
            <p className="fs-4 text-light">
              ...
              list your menu and product lists online, help you process orders.
                    ...
                    <button className="btn btn-warning fw-bold py-3 px-5">Login Here For Order Food</button>
          </div>
        </div>
        <div className="col-md-6 ">
          <img
